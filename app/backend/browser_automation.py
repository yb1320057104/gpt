...
PASSWORD_ROUTE_SELECTOR = (
    ...
    "or contains(normalize-space(.), 'mật khẩu') "
                            ...
                            await page.evaluate(
                                ...
                                () => {
                                  ...
                                  const target = passwordRouteCandidates.find(element => {
                                    ...
                                    return /continue with password|パスワードで続行|使用密码继续|使用密碼繼續|비밀번호로 계속|tiếp tục bằng mật khẩu|şifre ile devam|parola ile devam|mit passwort fortfahren/i.test(text);
                                  });
